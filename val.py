...
Usage:
    ...
    #python val75.py --data VisDrone.yaml --weights runs/train/exp7/weights/best.pt --img 640
"""
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'x.pt', help='model.pt path(s)')
